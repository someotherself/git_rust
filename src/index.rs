#![allow(dead_code)]
// use std::{fmt::{self, Display}, os::unix::fs::MetadataExt, path::PathBuf};
...
//     fn build_index(path: String) -> std::io::Result<()> {
//         // get root
...
//         let extended = false;
//         let stage = 0b00;
//         let name_len_field = if name_len >= 0xFFF { 0xFFF } else { name_len as u16 };
...
//         let entry = IndexEntry {ctime, ctime_nanos, mtime, mtime_nanos, dev, ino, mode, uid, gid, file_size, object_id, flags};
//         Ok(entry)
//     }
